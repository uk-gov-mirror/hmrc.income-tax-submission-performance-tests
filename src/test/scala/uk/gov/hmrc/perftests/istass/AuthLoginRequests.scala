...
object AuthLoginRequests extends ServicesConfiguration {
  ...
  def postLoginPage = http("Post Login page")
    .post(authLoginUrl + "/auth-login-stub/gg-sign-in": String)
    .formParam("authorityId", "")
    .formParam("gatewayToken", "")
    .formParam("redirectionUrl", s"$baseUrl/report-quarterly/income-and-expenses/submissions/individual/start")
    ...
    .formParam("enrolment[4].taxIdentifier[0].value", "9653921991")
